package com.heziz.liyang.receiver;
...
import com.heziz.liyang.utils.Constant;
import com.heziz.liyang.utils.ToastUtil;

import org.greenrobot.eventbus.EventBus;

/**
 * Created by yuanpk on 2018/8/home_bg_icon2  14:22
 * <p>
...
public class UsbStateChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(UsbManager.ACTION_USB_DEVICE_ATTACHED)) {
            ...
            EventBus.getDefault().post(new UsbStatusChangeEvent(isConnected));
        } else if (action.equals(Constant.ACTION_USB_PERMISSION)) {
