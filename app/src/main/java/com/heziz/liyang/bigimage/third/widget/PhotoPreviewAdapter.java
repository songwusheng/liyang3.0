package com.heziz.liyang.bigimage.third.widget;
...
import com.heziz.liyang.bigimage.third.widget.zoonview.PhotoView;
import com.heziz.liyang.bigimage.third.widget.zoonview.PhotoViewAttacher;
import com.heziz.liyang.bigimage.third.widget.zoonview.ViewHolderRecyclingPagerAdapter;
import com.heziz.liyang.bigimage.util.JImageShowUtil;
...
//        }
        ...
        if(path.startsWith("http")) {
            JImageShowUtil.displayImageScale(path, "", holder.mImageView);
        }else{
            int source = 0;
            try{
                source = Integer.valueOf(path);
                JImageShowUtil.displayImageScale(source, "", holder.mImageView);
