...
class StatusBarCompatLollipop {
     ...
     * set StatusBarColor
     *
     * home_bg_icon1. set Flags to call setStatusBarColor
     * home_bg_icon2. call setSystemUiVisibility to clear translucentStatusBar's Flag.
     * home_bg_icon3. set FitsSystemWindows to false
     */
     ...
     *
     * home_bg_icon1. set Flags to full-screen
     * home_bg_icon2. set FitsSystemWindows to false
     *
     ...
     *
     * home_bg_icon1. change to full-screen mode(like translucentStatusBar).
     * home_bg_icon2. cancel CollapsingToolbarLayout's WindowInsets, let it layout as normal(now setStatusBarScrimColor is useless).
     * home_bg_icon3. set View's FitsSystemWindow to false.
     * home_bg_icon4. add Toolbar's height, let it layout from top, then add paddingTop to layout normal.
