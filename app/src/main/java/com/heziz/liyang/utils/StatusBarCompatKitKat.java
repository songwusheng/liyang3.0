...
class StatusBarCompatKitKat {
    ...
    /**
     * home_bg_icon1. Add fake statusBarView.
     * home_bg_icon2. set tag to statusBarView.
     */
     ...
     * set StatusBarColor
     *
     * home_bg_icon1. set Window Flag : WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS
     * home_bg_icon2. removeFakeStatusBarViewIfExist
     * home_bg_icon3. addFakeStatusBarView
     * home_bg_icon4. addMarginTopToContentChild
     ...
     * home_bg_icon1. set Window Flag : WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS
     * home_bg_icon2. removeFakeStatusBarViewIfExist
     * home_bg_icon3. removeMarginTopOfContentChild
     * home_bg_icon4. cancel ContentChild's fitsSystemWindow
     */
     ...
     *
     * home_bg_icon1. set Window Flag : WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS
     * home_bg_icon2. set FitsSystemWindows for views.
     * home_bg_icon3. add Toolbar's height, let it layout from top, then add paddingTop to layout normal.
     * home_bg_icon4. removeFakeStatusBarViewIfExist
