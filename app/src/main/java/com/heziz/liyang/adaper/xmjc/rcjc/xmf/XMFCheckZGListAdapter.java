package com.heziz.liyang.adaper.xmjc.rcjc.xmf;
...
public class XMFCheckZGListAdapter extends BaseQuickAdapter<XMFCheckListBean,BaseViewHolder> {
    public XMFCheckZGListAdapter(Activity context, List<XMFCheckListBean> list) {
