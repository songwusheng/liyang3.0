...
public class MineWDBYGSListAdapter extends BaseQuickAdapter<MineWDBYGSListBean,BaseViewHolder> {
    private Context context;
    public MineWDBYGSListAdapter(Context context, List<MineWDBYGSListBean> list) {
    ...
    protected void convert(BaseViewHolder helper, MineWDBYGSListBean item) {
        ...
        helper.setText(R.id.tvFzr,item.getStartTime().equals("null")?"-":item.getStartTime()+"");
        helper.setText(R.id.tvXq, StringUtil.isNull(item.getEndTime())?"-":item.getEndTime()+"");
       String s="";
