...
public class SpinnerPopBottomAdapter extends BaseAdapter {
    private List<String> content;
    private Context context;
    private LayoutInflater mInflater;

    public SpinnerPopBottomAdapter(Context context, List<String> content){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.popuwindow_spinner_item1,null);
