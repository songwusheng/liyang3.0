...
import com.heziz.liyang.utils.FileManager;
...
public class ProgressWebView extends WebView {
    ...
    class MyWebChromeClient extends WebChromeClient {
        ...
        // For Android < home_bg_icon3.0
        public void openFileChooser(ValueCallback<Uri> uploadMsg) {
            mUploadMessage = uploadMsg;
            showOptions();
        }

        // For Android > home_bg_icon4.home_bg_icon1.home_bg_icon1
        public void openFileChooser(ValueCallback<Uri> uploadMsg,
...
//
    ...
    public void toCamera() {
        ...
        // 创建一个文件保存图片
        fileUri = FileProvider.getUriForFile(context,"com.heziz.liyang.fileProvider",FileManager.getImgFile(context));
//        Log.d("main", "fileUri=" + fileUri);
     ...
     * @param uri
     */
    public void onActivityCallBack(boolean isCamera, Uri uri,int n) {
        if(n==1){
            if (isCamera) {
                uri = fileUri;
            }
