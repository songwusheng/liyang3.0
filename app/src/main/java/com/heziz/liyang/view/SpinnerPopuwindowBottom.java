...
import com.heziz.liyang.adaper.SpinnerPopBottomAdapter;
...
public class SpinnerPopuwindowBottom extends PopupWindow {

    private View conentView;
    private ListView listView;
    private SpinnerPopBottomAdapter adapter;
    ...
    public SpinnerPopuwindowBottom(final Activity context, final String string, final List<String> list, AdapterView.OnItemClickListener itemsOnClick) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.popuwindow_spinner1, null);
        ...
        adapter = new SpinnerPopBottomAdapter(context,list);
