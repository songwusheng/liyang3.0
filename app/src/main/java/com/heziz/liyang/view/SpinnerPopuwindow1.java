...
import com.heziz.liyang.adaper.SpinnerPopAdapter1;
...
public class SpinnerPopuwindow1 extends PopupWindow {

    private View conentView;
    private ListView listView;
    private SpinnerPopAdapter1 adapter;
    ...
    public SpinnerPopuwindow1(final Activity context, final String string, final List<String> list, AdapterView.OnItemClickListener itemsOnClick) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.popuwindow_spinner2, null);
        ...
        adapter = new SpinnerPopAdapter1(context,list);
