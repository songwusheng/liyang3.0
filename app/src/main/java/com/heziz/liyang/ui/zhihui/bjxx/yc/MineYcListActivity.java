...
import com.heziz.liyang.adaper.yc.MineYcGJListAdapter;
...
public class MineYcListActivity extends BaseActivity implements View.OnClickListener {
...
//    LinearLayout llList;
    ...
    MineYcGJListAdapter adapter;
    private List<MineYcListBean> projectBeanList=new ArrayList<>();
...
//        showProgressDialog();
        String url1 = API.MINE_YC_LIST+"?access_token="+ MyApplication.getInstance().getUserInfor().getUuid();
        ...
        JsonCallBack1<SRequstBean<List<MineYcListBean>>> jsonCallBack1 = new JsonCallBack1<SRequstBean<List<MineYcListBean>>>() {
            ...
            @Override
            public void onError(com.lzy.okgo.model.Response<SRequstBean<List<MineYcListBean>>> response) {
                super.onError(response);
                dissmissProgressDialog();
            }
...
//        llList.setVisibility(View.VISIBLE);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent=new Intent(mContext, MineYcGJProjectXXListActivity.class);
