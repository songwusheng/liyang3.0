...
import com.heziz.liyang.fragment.rcjc.wdbygs.WcxmFragment;
import com.heziz.liyang.fragment.rcjc.wdbygs.YcxmFragment;
import com.heziz.liyang.fragment.rcjc.wdbygs.aq.AQWcxmFragment;
import com.heziz.liyang.fragment.rcjc.wdbygs.aq.AQYcxmFragment;

import butterknife.BindView;
import butterknife.ButterKnife;

public class AQZLCheckActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String type;
    private AQYcxmFragment ycxmFragment;
    private AQWcxmFragment wcxmFragment;
    @Override
    ...
    private void initViews() {
        ...
        if (ycxmFragment == null) {
            ycxmFragment = new AQYcxmFragment(type);
        ...
        rgBottom.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (radioGroup.getCheckedRadioButtonId()){
                    ...
                    case R.id.rb2:
                        if (wcxmFragment == null) {
                            wcxmFragment = new AQWcxmFragment(type);
