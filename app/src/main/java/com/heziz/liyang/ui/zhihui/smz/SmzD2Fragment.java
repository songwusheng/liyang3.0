...
import com.heziz.liyang.adaper.smz.SmzHmcListAdapter;
 ...
 */
public class SmzD2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    private List<SmzHMCBean> list = new ArrayList<>();
    ...
    @BindView(R.id.btnUp)
    Button btnUp;
    private SmzHmcListAdapter adapter;
    ...
    public static SmzD2Fragment newInstance(String param1) {
        SmzD2Fragment fragment = new SmzD2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_smz_d2, container, false);
    ...
    private void initViews() {
        tvT.setText("花名册");
        adapter = new SmzHmcListAdapter(getActivity(), list);
    ...
    private void initDatas() {
        showProgressDialog();
        String url2 = API.SMZ_HMC_LIST + "?access_token=" + MyApplication.getInstance().getUserInfor().getUuid();
