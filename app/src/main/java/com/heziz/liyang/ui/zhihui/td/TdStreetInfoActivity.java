...
public class TdStreetInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_td_street_info);
    ...
    private void initDatas() {
        ...
        if(userInfor.getPosition().equals("1")){
            params1.put("towerDeviceEndpoint",userInfor.getStation()+"");
    ...
    private void initListeners() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent=new Intent(TdStreetInfoActivity.this, TdProjectListActivity.class);
...
//                intent.putExtra("object",projectBeanList.get(position).getManagerRoleId());
    ...
    private void getTdNum() {
        ...
        if(userInfor.getPosition().equals("1")){
            paramsnum.put("towerDeviceEndpoint",userInfor.getStation()+"");
        }else if(userInfor.getPosition().equals("2")){
    ...
    private void initProjectData() {
        showProgressDialog();
        String url1 = API.TD_STREET_LIST+"?access_token="+ MyApplication.getInstance().getUserInfor().getUuid();
