...
import com.heziz.liyang.adaper.sjj.MySjjExtendableListViewAdapter;
import com.heziz.liyang.adaper.sp.MySpExtendableListViewAdapter;
...
import com.heziz.liyang.bean.sp.SpProjectBean;
...
public class SjjProjectListActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sjj_project_list);
...
//                showMark(projectBeanList);
            ...
            @Override
            public void onError(com.lzy.okgo.model.Response<SRequstBean<RequestBean<List<SjjProjectBean>>>> response) {
                super.onError(response);
                dissmissProgressDialog();
            }
